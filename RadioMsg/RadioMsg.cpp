...
char RadioMsgString[][64] = 
{
    ...
    [NOTIFY_MSG_EXHAUSTED] = "NOTIFY_MSG_EXHAUSTED",
    [NOTIFY_PLL_RESET] = "NOTIFY_PLL_RESET",
    [NOTIFY_PLL_LOST_LOCK] = "NOTIFY_PLL_LOST_LOCK",
    [NOTIFY_PLL_LOCK] = "NOTIFY_PLL_LOCK",
    ...
    [NOTIFY_DATA_START] = "NOTIFY_DATA_START",
    [NOTIFY_DATA_BODY] = "NOTIFY_DATA_BODY",
};
